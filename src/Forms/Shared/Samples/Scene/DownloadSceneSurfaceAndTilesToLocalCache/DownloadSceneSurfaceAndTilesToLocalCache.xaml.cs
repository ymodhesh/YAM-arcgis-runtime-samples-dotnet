...
namespace ArcGISRuntimeXamarin.Samples.DownloadSceneSurfaceAndTilesToLocalCache
{
    ...
    public partial class DownloadSceneSurfaceAndTilesToLocalCache : ContentPage
    {
