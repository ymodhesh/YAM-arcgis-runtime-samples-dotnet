...
namespace ArcGISRuntimeMaui.Samples.DisplayUtilityNetworkContainer
{
    ...
    public partial class DisplayUtilityNetworkContainer : ContentPage
    {
        ...
        private async Task Initialize()
        {
            ...
            Symbol attachmentSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dot, System.Drawing.Color.Blue, 5d);
            Symbol boundingBoxSymbol = new SimpleLineSymbol(SimpleLineSymbolStyle.Dash, System.Drawing.Color.Yellow, 5d);
